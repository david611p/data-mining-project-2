...
y_train = train_set['Mjob']
X_train = train_set.drop(columns=['Mjob'])
y_test = test_set['Mjob']
X_test = test_set.drop(columns=['Mjob'])
...
print("Random Forest Results (PCA Mjob, n_estimators=200):")
...
print("")
print("SVM Results (PCA Mjob, C=1):")
